...
-- This is the SPARK contract and interface specification for the 
-- Fat-Bat account management system
-- Derived by Kun Qin, No.674285
...
is
   ...
   procedure Init with 
     Post => 
     (for all I in Users'Range => Users(I) = False) and
